    ...
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<ProductDTO> Update(ProductDTO objDTO)
        {
            ...
            if(objFromDb != null)
            {
                ...
                objDTO.ImageUrl= objDTO.ImageUrl;
                objDTO.CategoryId= objDTO.CategoryId;
                objDTO.Color= objDTO.Color;
                objDTO.ShopFavorites= objDTO.ShopFavorites;
                objDTO.CustomerFavorites= objDTO.CustomerFavorites;
